...
<body>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 col-xs-6 work">
					<img class="img-responsive" src="./<?=base_url()?>assets/images/work1.jpg" alt="">
					<div class="overlay"></div>
					<div class="work-content">
						...
						<div class="work-link">
							...
							<a class="lightbox" href="./<?=base_url()?>assets/images/work1.jpg"><i class="fa fa-search"></i></a>
						</div>
					</div>
				</div>
				<!-- /Work -->
				...
				<!-- Work -->
				<div class="col-md-4 col-xs-6 work">
					<img class="img-responsive" src="./<?=base_url()?>assets/images/work2.jpg" alt="">
					<div class="overlay"></div>
					<div class="work-content">
						<span>Category</span>
						<h3>Lorem ipsum dolor</h3>
						<div class="work-link">
							<a href="#"><i class="fa fa-external-link"></i></a>
							<a class="lightbox" href="./<?=base_url()?>assets/images/work2.jpg"><i class="fa fa-search"></i></a>
						</div>
					</div>
				</div>
				<!-- /Work -->
				...
				<!-- Work -->
				<div class="col-md-4 col-xs-6 work">
					<img class="img-responsive" src="./<?=base_url()?>assets/images/work3.jpg" alt="">
					<div class="overlay"></div>
					<div class="work-content">
						<span>Category</span>
						<h3>Lorem ipsum dolor</h3>
						<div class="work-link">
							<a href="#"><i class="fa fa-external-link"></i></a>
							<a class="lightbox" href="./<?=base_url()?>assets/images/work3.jpg"><i class="fa fa-search"></i></a>
						</div>
					</div>
				</div>
				<!-- /Work -->
				...
				<!-- Work -->
				<div class="col-md-4 col-xs-6 work">
					<img class="img-responsive" src="./<?=base_url()?>assets/images/work4.jpg" alt="">
					<div class="overlay"></div>
					<div class="work-content">
						<span>Category</span>
						<h3>Lorem ipsum dolor</h3>
						<div class="work-link">
							<a href="#"><i class="fa fa-external-link"></i></a>
							<a class="lightbox" href="./<?=base_url()?>assets/images/work4.jpg"><i class="fa fa-search"></i></a>
						</div>
					</div>
				</div>
				<!-- /Work -->
				...
				<!-- Work -->
				<div class="col-md-4 col-xs-6 work">
					<img class="img-responsive" src="./<?=base_url()?>assets/images/work5.jpg" alt="">
					<div class="overlay"></div>
					<div class="work-content">
						<span>Category</span>
						<h3>Lorem ipsum dolor</h3>
						<div class="work-link">
							<a href="#"><i class="fa fa-external-link"></i></a>
							<a class="lightbox" href="./<?=base_url()?>assets/images/work5.jpg"><i class="fa fa-search"></i></a>
						</div>
					</div>
				</div>
				<!-- /Work -->
				...
				<!-- Work -->
				<div class="col-md-4 col-xs-6 work">
					<img class="img-responsive" src="./<?=base_url()?>assets/images/work6.jpg" alt="">
					<div class="overlay"></div>
					<div class="work-content">
						<span>Category</span>
						<h3>Lorem ipsum dolor</h3>
						<div class="work-link">
							<a href="#"><i class="fa fa-external-link"></i></a>
							<a class="lightbox" href="./<?=base_url()?>assets/images/work6.jpg"><i class="fa fa-search"></i></a>
						</div>
					</div>
				</div>
				<!-- /Work -->
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div id="about-slider" class="owl-carousel owl-theme">
						<img class="img-responsive" src="./<?=base_url()?>assets/images/about1.jpg" alt="">
						<img class="img-responsive" src="./<?=base_url()?>assets/images/about2.jpg" alt="">
						<img class="img-responsive" src="./<?=base_url()?>assets/images/about1.jpg" alt="">
						<img class="img-responsive" src="./<?=base_url()?>assets/images/about2.jpg" alt="">
					</div>
				</div>
	...
	<div id="testimonial" class="section md-padding">
		...
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('./<?=base_url()?>assets/images/background3.jpg');">
			<div class="overlay"></div>
		</div>
		<!-- /Background Image -->
					...
					<div id="testimonial-slider" class="owl-carousel owl-theme">
						...
						<div class="testimonial">
							<div class="testimonial-meta">
								<img src="./<?=base_url()?>assets/images/perso1.jpg" alt="">
						...
						<div class="testimonial">
							<div class="testimonial-meta">
								<img src="./<?=base_url()?>assets/images/perso2.jpg" alt="">
								<h3 class="white-text">John Doe</h3>
								<span>Web Designer</span>
							</div>
							<p class="white-text">Molestie at elementum eu facilisis sed odio. Scelerisque in dictum non consectetur a erat. Aliquam id diam maecenas ultricies mi eget mauris.</p>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="team">
						<div class="team-img">
							<img class="img-responsive" src="./<?=base_url()?>assets/images/team1.jpg" alt="">
							<div class="overlay">
				...
				<div class="col-sm-4">
					<div class="team">
						<div class="team-img">
							<img class="img-responsive" src="./<?=base_url()?>assets/images/team2.jpg" alt="">
							<div class="overlay">
								<div class="team-social">
									<a href="#"><i class="fa fa-facebook"></i></a>
									<a href="#"><i class="fa fa-google-plus"></i></a>
				...
				<div class="col-sm-4">
					<div class="team">
						<div class="team-img">
							<img class="img-responsive" src="./<?=base_url()?>assets/images/team3.jpg" alt="">
							<div class="overlay">
								<div class="team-social">
									<a href="#"><i class="fa fa-facebook"></i></a>
									<a href="#"><i class="fa fa-google-plus"></i></a>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="blog">
						<div class="blog-img">
							<img class="img-responsive" src="./<?=base_url()?>assets/images/blog1.jpg" alt="">
						</div>
				...
				<div class="col-md-4">
					<div class="blog">
						<div class="blog-img">
							<img class="img-responsive" src="./<?=base_url()?>assets/images/blog2.jpg" alt="">
						</div>
						<div class="blog-content">
							<ul class="blog-meta">
								<li><i class="fa fa-user"></i>John doe</li>
				...
				<div class="col-md-4">
					<div class="blog">
						<div class="blog-img">
							<img class="img-responsive"  src="./<?=base_url()?>assets/images/blog3.jpg" alt="">
						</div>
						<div class="blog-content">
							<ul class="blog-meta">
								<li><i class="fa fa-user"></i>John doe</li>
