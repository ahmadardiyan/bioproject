...
--
-- Host: localhost:3306
-- Generation Time: 23 Mei 2019 pada 22.08
...
CREATE TABLE `kecamatan` (
  `id_kec` char(7) COLLATE utf8_unicode_ci NOT NULL,
  `id_kab` char(4) COLLATE utf8_unicode_ci NOT NULL,
  `nama_kec` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('29', 'Ahmad Ardiyanto', 'Laki-laki', 'Magelang', '1996-10-19', '087834284756', '   Macanan, Tanjung ', '', '2105050', '2105', '21', '5ce622079b975.jpg', 'AKu Adalah', '2019-05-23 04:32:10', '2019-05-23 03:55:54');
...
(1, '1', 'UIN Sunan Kalijaga', 'S1', 'Teknik Informatika', 2016, 2019, '2019-05-21 03:51:19', NULL);
...
(3, '1', 'CV Maju Jaya', 'Programmer', '', 0, 2017, 0, 2019, '2019-05-21 03:05:55', NULL);
...
INSERT INTO `perusahaan` (`id_user`, `nama_perusahaan`, `deskripsi_perusahaan`, `website_perusahaan`, `phone`, `alamat_perusahaan`, `id_kec`, `id_kab`, `id_prov`, `logo_perusahaan`, `created_at`, `modified_at`) VALUES
('25', 'CV Maju Jaya', 'a', 'q', '3', ' a ', '1403080', '1403', '14', '5ce51b3bbd3d4.jpg', '2019-05-22 22:05:52', NULL),
('27', '', '', '', '', '', '', '', '', 'company.png', '2019-05-23 03:46:39', NULL),
('28', '', '', '', '', '', '', '', '0', 'company.png', '2019-05-23 03:53:38', NULL);
...
('PRT1904050001', '1', 'UI Web Modern', 'Design UI Web Modern', '5ce368a9bc8b8.jpg', '2019-04-05 09:57:04', NULL),
('PRT1904180001', '1', 'Web Gym Sport', 'Website Gym Sport', '5ce3682c620e9.jpg', '2019-04-18 11:44:41', NULL),
('PRT1905190001', '1', 'Design Eid Mubarak', 'Desain grafis mempertingati hari raya idul fitri 1440 H', '5ce367c6ca118.jpg', '2019-05-19 12:44:37', NULL);
...
INSERT INTO `service` (`id`, `icon`, `title`, `deskripsi`) VALUES
(1, 'fas fa-fw fa-file-code', 'App Development', 'We offer'),
(3, 'fas fa-fw fa-wrench', 'Creative Idea', '-'),
(4, 'fas fa-fw fa-envelope-open-text', 'Marketing', '-'),
(5, 'fas fa-fw fa-angle-double-up', 'Awesome Support', '--'),
(6, 'fas fa-fw fa-hourglass', 'Brand Design', '--'),
(7, 'fas fa-fw fa-crosshairs', 'Graphic Design', '--');
...
INSERT INTO `user` (`id`, `firstname`, `lastname`, `email`, `image`, `password`, `role_id`, `is_active`, `date_created`) VALUES
(6, 'Erizta', 'Alifa P', 'eriztaalifad@gmail.com', 'DvJQK5yWwAA59-e1.jpg', '$2y$10$jyboc1uPL7i54ylXG8eTluFI7k8tjQZOK.ZomNKxXm/DAJ8iXiGre', 1, 1, 1553405772),
(7, 'Atzire', 'Afilad', 'iamerizta900@gmail.com', 'IMG-20180624-WA0023.jpg', '$2y$10$XxM0NPZp8XYp5gBZN1fTbOXgYlqyoyR0nmERanW2a93z9Ne.2PXHy', 2, 1, 1553406440);
...
INSERT INTO `users` (`id_user`, `email`, `username`, `password`, `level`, `role`, `token`, `created_at`, `updated_at`) VALUES
(29, 'ahmadardiyanto23@gmail.com', 'Ahmad', '$2y$10$szEM4F5HC/8BU5EPwSMDF.QSVREjnU3Mmxgxs0ldKPI7RrsfSQ8YK', 'company', 1, 'YM7sFu9xS4D5gVqa', '2019-05-23 03:55:28', '2019-05-23 03:55:28');
